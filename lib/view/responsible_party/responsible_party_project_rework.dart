...
import 'responsible_party_project_rework_edit.dart';

class ResponsiblePartyReworkPage extends StatefulWidget {
  final String projectUpdatesID;

  const ResponsiblePartyReworkPage({
    Key? key,
    required this.projectUpdatesID,
  }) : super(key: key);

  @override
  State<ResponsiblePartyReworkPage> createState() =>
      _ResponsiblePartyReworkPageState();
}

class _ResponsiblePartyReworkPageState
    extends State<ResponsiblePartyReworkPage> {
  var logger = Logger();
              ...
              child: IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ResponsiblePartyReworkEditPage(
                              projectUpdatesID: widget.projectUpdatesID,
                              projectUpdatesNotes: projectUpdatesNotes!,
          ...
          child: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              if (!snapshot.hasData) {
                ...
                // projectUpdatesTitle
                projectUpdatesTitle = map["projectUpdatesTitle"];
