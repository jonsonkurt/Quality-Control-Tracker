...
class InspectorProjectUpdatesCompletedPage extends StatefulWidget {
  final String projectUpdatesID;

  const InspectorProjectUpdatesCompletedPage({
    Key? key,
    required this.projectUpdatesID,
  }) : super(key: key);

  @override
  State<InspectorProjectUpdatesCompletedPage> createState() =>
      _InspectorProjectUpdatesCompletedPageState();
}

class _InspectorProjectUpdatesCompletedPageState
    extends State<InspectorProjectUpdatesCompletedPage> {
  var logger = Logger();
