...
class InspectorProjectUpdatesReworkPage extends StatefulWidget {
  final String projectUpdatesID;

  const InspectorProjectUpdatesReworkPage({
    Key? key,
    required this.projectUpdatesID,
  }) : super(key: key);

  @override
  State<InspectorProjectUpdatesReworkPage> createState() =>
      _InspectorProjectUpdatesReworkPageState();
}

class _InspectorProjectUpdatesReworkPageState
    extends State<InspectorProjectUpdatesReworkPage> {
  var logger = Logger();
          ...
          child: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              if (!snapshot.hasData) {
                ...
                // projectUpdates inspectionDate
                int projectUpdatesSubmissionDateLength =
                    map["inspectionDate"].length;
                String? projectUpdatesInspectionDate = map["inspectionDate"]
                    ["inspectionDate$projectUpdatesSubmissionDateLength"];

                String projectUpdatesTag =
                    convertJobTitle(map['rpRole'].toString());

                // String projectUpdatesNotes = map['firstName'];
                int projectUpdatesNotesLength = map["inspectorNotes"].length;
                String? projectUpdatesNotes = map["inspectorNotes"]
                    ["inspectorNotes$projectUpdatesNotesLength"];
